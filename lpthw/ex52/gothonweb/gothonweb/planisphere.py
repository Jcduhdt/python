...
teeth, and evil clown costume flowing around hs hate
...
clown costume than the last. They haven't pilled their
weapons out yet, as they see the active bomb under your
arm and don't want to sit it off.
""")
...
carefully place the bomb on the door, open it, and then
...
def load_room(name):
    ...
    Who gets to set name? Can that expose a varibale?
    """
